...
export default function IntelCropRecommendationForm({ setIntelCropRecommendationForm }) {
  ...
  return (
    <div className="intel-crop-rec-root">
      <div className="intel-crop-rec-main-block">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {!loading && (
              <div className="btn-block">
                ...
                <button
                  onClick={() => setIntelCropRecommendationForm(false)}
                  className="closebtn-crop-rec"
                >
                  Close
                </button>
              </div>
